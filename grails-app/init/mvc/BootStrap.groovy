...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        new Workout(date: Date.parse("yyyy-MM-dd hh:mm:ss", "2017-04-12 11:00:00"), duration: 60, type: "Strength", exerciseList: [clean,squat]).save(failOnError:true)
        new Workout(date: Date.parse("yyyy-MM-dd hh:mm:ss", "2017-03-02 11:00:00"), duration: 80, type: "Strength", exerciseList: [snatch,bizepsCurl]).save(failOnError:true)
        new Workout(date: Date.parse("yyyy-MM-dd hh:mm:ss", "2017-04-14 11:00:00"), duration: 90, type: "Endurance", exerciseList: [overheadSquat,squat]).save(failOnError:true)
        new Workout(date: Date.parse("yyyy-MM-dd hh:mm:ss", "2017-05-04 11:00:00"), duration: 100, type: "Explosiveness", exerciseList: [benchpress,bizepsCurl]).save(failOnError:true)
